...
- Quickly view SuperMemo glossary definitions by hovering over links in SuperMemo.
...
- You can choose to add a particular highlight to glossary links to make it clear they are compatible with the plugin.
